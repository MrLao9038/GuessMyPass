...
real_password = str(input("Please Enter Password:  "))

guess_password = ""

while guess_password != real_password:
    guess_password = random.choices(char_list, k=len(real_password))
    print("Attempting to Guess Password: " + str(guess_password))
